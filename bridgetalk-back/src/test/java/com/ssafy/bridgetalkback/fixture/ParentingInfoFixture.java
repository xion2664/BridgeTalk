...
public enum ParentingInfoFixture {
    PARENTINGINFO_01("title_kor1", "title_viet1", "content_kor1", "content_viet1","link1", Age.PROSPECTIVE),
    PARENTINGINFO_02("title_kor2", "title_viet2", "content_kor2", "content_viet2", "link2", Age.PROSPECTIVE)
    ;
    ...
    public ParentingInfo toParentingInfo() {
        return ParentingInfo.createParentingInfo(title_kor, title_viet, content_kor, content_viet, link, age);
    }
}
